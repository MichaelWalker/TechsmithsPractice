...
Use the tests to check that you have got it correct! You should see each test changing from 'Failed' to 'Passed' as you go along.
...
Note - initially 11 of the 12 tests should fail, and 1 should pass (the example). Your job is to make them all go green!
